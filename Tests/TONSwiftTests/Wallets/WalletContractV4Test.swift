...
final class WalletContractV4Test: XCTestCase {
    ...
    func testR1() throws {
        ...
        XCTAssertEqual(
            ...
            "x{0000000029A9A3175754865E86D0ADE1199301BBB0319A25ED6B129C4B0A57F28F62449B3DF9C5224_}"
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(try cell.toString(), """
            x{000355EAEDB79E63A350B6700310D9E31F6CBD9285B5C990BBF510385FC7D2CCCF6412C8005DD767B8178078500C4498F011565D4C56901B90A5A9F7B9DAB10F}
            """)
    }
