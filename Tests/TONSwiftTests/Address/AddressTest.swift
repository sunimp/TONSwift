...
final class AddressTest: XCTestCase {
    func testAddress() throws {
        ...
        XCTAssertEqual(
            ...
            Data(hex: "2cf55953e92efbeadab7ba725c3f93a0b23f842cbba72d7b8e6f510a70e422e3")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            address.toString(urlSafe: false, testOnly: true),
        ...
        XCTAssertEqual(
            address.toString(urlSafe: false, bounceable: false),
