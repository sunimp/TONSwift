...
final class SerializationTest: XCTestCase {
    ...
    func testSerialization() throws {
        ...
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: false, crc32: false).base64EncodedString(),
            "te6ccgEBAQEAAgAAAA=="
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: false, crc32: true).base64EncodedString(),
            "te6cckEBAQEAAgAAAEysuc0="
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: false).base64EncodedString(),
            "te6ccoEBAQEAAgAAAAA="
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: true).base64EncodedString(),
        ...
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: false).base64EncodedString(),
            "te6ccoEBAQEABgAAAAgHW80V"
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: true).base64EncodedString(),
            "te6ccsEBAQEABgAAAAgHW80Vyf0TAA=="
        )
        ...
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: false).base64EncodedString(),
            "te6ccoEBAQEABwAAAAkB1vNFYA=="
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: true).base64EncodedString(),
            "te6ccsEBAQEABwAAAAkB1vNFYMkX0oY="
        )
        ...
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: false).base64EncodedString(),
            "te6ccoEBAgEADQAABwEIOt5osQEACAdbzRU="
        )
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: true).base64EncodedString(),
            "te6ccsEBAgEADQAABwEIOt5osQEACAdbzRWZVy8t"
        )
        XCTAssertEqual(try deserializeBoc(src: Data(base64Encoded: "te6ccgEBAgEADQABCDreaLEBAAgHW80V")!)[0], cell)
        XCTAssertEqual(
            try deserializeBoc(src: Data(base64Encoded: "te6cckEBAgEADQABCDreaLEBAAgHW80VSW/75w==")!)[0],
            cell
        )
        XCTAssertEqual(try deserializeBoc(src: Data(base64Encoded: "te6ccoEBAgEADQAABwEIOt5osQEACAdbzRU=")!)[0], cell)
        XCTAssertEqual(
            try deserializeBoc(src: Data(base64Encoded: "te6ccsEBAgEADQAABwEIOt5osQEACAdbzRWZVy8t")!)[0],
            cell
        )
        ...
        XCTAssertEqual(
            try serializeBoc(root: cell, idx: true, crc32: true).base64EncodedString(),
            "te6ccsEBAgEADwAACQMIOt5osQEBAQAIB1vNFT/vUE4="
        )
        XCTAssertEqual(try deserializeBoc(src: Data(base64Encoded: "te6ccgEBAgEADwADCDreaLEBAQEACAdbzRU=")!)[0], cell)
        XCTAssertEqual(
            try deserializeBoc(src: Data(base64Encoded: "te6cckEBAgEADwADCDreaLEBAQEACAdbzRWpQD2p")!)[0],
            cell
        )
        XCTAssertEqual(
            try deserializeBoc(src: Data(base64Encoded: "te6ccoEBAgEADwAACQMIOt5osQEBAQAIB1vNFQ==")!)[0],
            cell
        )
        XCTAssertEqual(
            try deserializeBoc(src: Data(base64Encoded: "te6ccsEBAgEADwAACQMIOt5osQEBAQAIB1vNFT/vUE4=")!)[0],
            cell
        )
    }
}
